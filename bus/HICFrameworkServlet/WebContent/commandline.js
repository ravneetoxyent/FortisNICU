...
function CommandLineEditor (params) {
  ...
  function create() {
    ...
    dom.input.id = 'input_expression';
    dom.input.title = 'Enter an expression';
    dom.input.onkeydown = onKeyDown;
    dom.inputLeft.appendChild(dom.input);

    // create an eval button
    dom.btnEval = document.createElement('input');
    dom.btnEval.type= 'submit';
    dom.btnEval.value= 'Calculate';
    dom.btnEval.id='calc_hit';
