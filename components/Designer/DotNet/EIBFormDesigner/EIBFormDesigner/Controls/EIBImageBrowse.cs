...
{
    class EIBImageBrowse : EIBImageBrowseBase
    {
        
    }
    class EIBImageBrowseBase : EIBImageBrowseUserControl, ITool, IEIBControl, ICustomSizableControl
    {
  ...
  TypeConverter(typeof(EIBFormDesigner.Property.IsForm)), Description("Sets the Form Status"), Category("Data")]
        ...
        public EIBImageBrowseBase():base()
        {
            if (string.IsNullOrEmpty(this.Name))
            {
                this.Name = "imagebrowse" + counter;
            }
