...
{
    class EIBDatePicker : EIBDatePickerBase
    {

    }
    class EIBDatePickerBase : UserControl, ITool, IEIBControl, ICustomSizableControl
    {
       ...
       [  Browsable(true),DesignerSerializationVisibility(DesignerSerializationVisibility.Content),
        ...
        public virtual string CustomFormatType
        {
            get
            {
            ...
            set
            {
                ...
                if (value.Trim().Equals("short"))
                {
                    dateTimePicker.Format = DateTimePickerFormat.Custom;
                    dateTimePicker.CustomFormat = "MM/dd/yy";
                }
                if (value.Trim().Equals("medium"))
                {
                    dateTimePicker.Format = DateTimePickerFormat.Custom;
                    dateTimePicker.CustomFormat = "MMM d,yyyy";
                }
                if (value.Trim().Equals("long"))
                {
                    dateTimePicker.Format = DateTimePickerFormat.Custom;
                    dateTimePicker.CustomFormat = "MMMM d,yyyy";
                }
                if (value.Trim().Equals("long+medium"))
                {
                    dateTimePicker.Format = DateTimePickerFormat.Custom;
                    dateTimePicker.CustomFormat = "MMMM d,yyyy h:mm:ss tt";
                }
       ...
       public string IsMandatory
       {
        ...
        public void checkUniqueness(string datapickerName)
        {
            if (datapickerNames.Contains(datapickerName))
            {
                counter++;
                this.Name = "datepicker" + counter;
                checkUniqueness(this.Name);
        ...
        {
            this.Name = EIBControlCollection.CheckControlForUniqueness<EIBDatePicker>(this.Name);
            if (string.IsNullOrEmpty(this.ControlName))
            {
                this.ControlName = this.Name;
            }
            ...
            EIBControlCollection.DatePickerlist.Add(this.Name, this.Name);
            counter = 0;
