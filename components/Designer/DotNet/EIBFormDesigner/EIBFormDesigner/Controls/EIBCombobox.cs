...
{
    class EIBCombobox : EIBComboboxBase
    {
    }
    class EIBComboboxBase : ComboBox, ITool, IEIBControl, ICustomSizableControl
    {
    ...
    TypeConverter(typeof(EIBFormDesigner.Property.IsForm)), Description("Sets the Form Status"), Category("Data")]
        ...
        [Browsable(true), EditorBrowsable(EditorBrowsableState.Never), Description("Sets the Read Only of control"), Category("Appearance")]
        ...
        public EIBComboboxBase()
        {
            this.Size = new Size(width, height);
            if (string.IsNullOrEmpty(this.Name))
            {
                this.Name = "combobox" + counter;
            }
        ...
        {
            this.Name = EIBControlCollection.CheckControlForUniqueness<EIBCombobox>(this.Name);
            if (string.IsNullOrEmpty(this.ControlName))
            {
                this.ControlName = this.Name;
            }
            ...
            EIBControlCollection.ComboBoxlist.Add(this.Name, this.Name);
            counter = 0;
        }
