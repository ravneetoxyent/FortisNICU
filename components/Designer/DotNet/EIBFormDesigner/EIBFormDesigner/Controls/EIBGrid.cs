...
{
    class GridListConverter : StringConverter
    {
        ...
        {
            return new StandardValuesCollection(EIBGrid.searchList);
        }
    }
	...
	/// </summary>
	[ToolboxItem(true)]
    public class EIBGrid : System.Windows.Forms.Panel,  ITool, IEIBControl, IContainerControl
	{
        ...
        [Browsable(true), EditorBrowsable(EditorBrowsableState.Never), Description("Sets the name of Search Field"), Category("Data"), TypeConverter(typeof(GridListConverter))]
        ...
        [Browsable(true), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), Description("Sets the Checkmark property of control"), Category("Data")]
        ...
        GridType gridType;
        [Browsable(true), DefaultValue(true), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), Description("Sets the GridType of the control "), Category("Appearance")]
  ...
  TypeConverter(typeof(EIBFormDesigner.Property.IsForm)), Description("Sets the Form Status"), Category("Data")]
      ...
      TypeConverter(typeof(EIBFormDesigner.Property.IsMandatory)), Description("Sets the mandatory field"), Category("Data")]
        ...
        public EIBGrid()
		{
			...
			InitializeComponent();
            this.Layout += new LayoutEventHandler(FormDesigner.eventManager.TableControl_Layout);
