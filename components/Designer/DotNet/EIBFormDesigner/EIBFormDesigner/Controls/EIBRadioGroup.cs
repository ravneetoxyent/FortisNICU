...
{
    public class EIBRadioGroup : EIBRadioGroupBase
    {

    }
    public class EIBRadioGroupBase : Panel, ITool, IEIBControl, IContainerControl, ICustomSizableControl
    {
  ...
  TypeConverter(typeof(EIBFormDesigner.Property.IsForm)), Description("Sets the Form Status"), Category("Data")]
        ...
        public EIBRadioGroupBase()
        {
            if (string.IsNullOrEmpty(this.Name))
            {
                this.Name = "radiogroup" + counter;
            }
            ...
            this.AccessibleName = "radiogroup" + counter;
