...
{
    public class EIBTextBox : EIBTextBoxBase
    {
    }
    public class EIBTextBoxBase : TextBox, ITool, IEIBControl, ICustomSizableControl
    {
	    ...
	    internal static Hashtable textboxNames = new Hashtable();
        /// <summary>
        /// /
        /// 
        /// </summary>
        ...
        private string onChangingValue;
        public string OnChanging
        {
            get
            {
                return onChangingValue;
            }
            set
            {
        ...
        MoldType mold;
        [Browsable(true), DefaultValue(true), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), Description("Sets the mold of the control to rounded"), Category("Appearance")]
        ...
        bool searchField;
        [Browsable(true),DefaultValue(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), Description("Sets the SearchField property of control"), Category("Appearance")]
        ...
        int minLength;
        [Browsable(true), DefaultValue(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), Description("Sets the MinLength property of control"), Category("Behavior")]
        ...
        //string constraint;
        //[Browsable(true), DefaultValue(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), Description("Sets the constraint for a control"), Category("Behavior")]
  ...
  TypeConverter(typeof(EIBFormDesigner.Property.IsForm)), Description("Sets the Form Status"), Category("Data")]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content),
  TypeConverter(typeof(EIBFormDesigner.Property.ValueTypes)), Description("Sets the Type of TextBox"), Category("Data"),DefaultValue("AlphaNumeric")]
        public string ValueType
        {
            get
            {
    ...
    //    public void checkUniqueness(string textboxName)
    //{
    //    if (textboxNames.Contains(textboxName))
    //    {
    //    counter++;
