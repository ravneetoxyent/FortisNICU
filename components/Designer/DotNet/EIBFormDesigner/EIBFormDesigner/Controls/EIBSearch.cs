...
{
    public class EIBSearch : EIBSearchBase
    {
    }
    public class EIBSearchBase : Label, ITool, IEIBControl
    {
        internal static Hashtable searchNames = new Hashtable();
        internal SearchDesigner searchDesigner;
        ...
        public SearchDesigner SearchDesign
        {
            get
            {
  ...
  TypeConverter(typeof(EIBFormDesigner.Property.IsForm)), Description("Sets the Form Status"), Category("Data")]
        ...
        public EIBSearchBase()
        {

        }
        public void checkUniqueness(string searchName)
        {
