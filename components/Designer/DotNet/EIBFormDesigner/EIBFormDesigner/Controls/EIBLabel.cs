...
{
    public class EIBLabel : EIBLabelBase
    {
    }
    public class EIBLabelBase : Label, ITool, IEIBControl, ICustomSizableControl
    {
        ...
        internal static Hashtable labelNames = new Hashtable();
        ...
        [Browsable(true), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), Description("Sets the multiline property of the control."), Category("Appearance")]
  ...
  TypeConverter(typeof(EIBFormDesigner.Property.IsForm)), Description("Sets the Form Status"), Category("Data")]
        ...
        //public void checkUniqueness(string labelName)
        //{
        ...
        public void InitiateSettings(EIBFormDesigner.Designer.FormDesigner form)
        {
            ...
            this.Name=EIBControlCollection.CheckControlForUniqueness<EIBLabel>(this.Name);
            if (string.IsNullOrEmpty(this.ControlName))
            {
                this.ControlName = this.Name;
            }
            ...
            EIBControlCollection.Labellist.Add(this.Name, this.Name);
            counter = 0;
