...
{
    class EIBButton : EIBButtonBase
    {

    }
    class EIBButtonBase : Button, ITool, IEIBControl, ICustomSizableControl
    {
        ...
        internal static Hashtable buttonNames = new Hashtable();
        ...
        [Browsable(true), Description("Set VisibleTo property for the control"), Category("Data"),
        EditorAttribute(typeof(VisibleToEditor), typeof(UITypeEditor)),
        TypeConverter(typeof(VisibleToConverter))
        ]
        ...
        [Browsable(true), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), Description("Sets the DefaultColor property of control"), Category("Appearance")]
        ...
        [Browsable(true), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), Description("Renders the Cursor property of the control."), Category("Appearance")]
        ...
        [Browsable(true), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), Description("Sets the Border Size of the Control."), Category("Appearance")]
        public int BorderSize
        {
            ...
            set
            {
                if (value < 0)
                {
                    MessageBox.Show("Wrong Border Size");
                }
                else
                {
  ...
  TypeConverter(typeof(EIBFormDesigner.Property.IsForm)), Description("Sets the Form Status"), Category("Data")]
        ...
        public string OnBlur { get { return onBlur; } set { onBlur = value; } }
        ...
        bool renderTextWithImage = false;
        [Browsable(true), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), Description("Renders the text with the background image ."), Category("Appearance")]
        public bool RenderTextWithImage
        {
            get
            {
                return renderTextWithImage;
            }
            set
            {
                renderTextWithImage = value;
            }
        }
        /// <summary>
        ...
        public string UniqueId
        {
            ...
            set
            {
                if (this.uniqueId == null)// 
                {
                    ...
                    //if (value == "")
                    //{
                    //    MessageBox.Show("UniqueId cannot be null");
                    //}
                    //else if (value.Contains("-") || value.Contains("_"))
                    //{
                    //    MessageBox.Show("UniqueId mustnot contain UnderScore(_) and hyphen(-).");
                    //}
                    //else
                    //{
                    //    uniqueId = value;
                ...
                if (!(uniqueId == null))
                {
                    //if (value.Contains(" "))
                    //{
                    //    MessageBox.Show("Please remove blanks from UniqueId");
                    //}
                    //if (value == "" || value == null)
                    //{
                    //    MessageBox.Show("UniqueId can not be null");
                    //}
                    ...
                    {
                        ////Now user wants to change UniqueId, so keep the old
                        ////UniqueId in a reference which we will use to delete files
                        //if (uniqueId != null && !FormDesignerUtilities.oldFilesToBeDeleted.Contains(uniqueId))
                        //    FormDesignerUtilities.oldFilesToBeDeleted.Add(uniqueId);
                        uniqueId = value;
                        //this.Name = value;
                        //if (this.Parent is BaseWindow)
                        //{
                        //    //Check is UniqueId already Exists
        ...
        Browsable(true),
        Category("Data"),
        Description("Set the Margin of a control.")
        ]
        ...
        {
            this.Name = EIBControlCollection.CheckControlForUniqueness<EIBButton>(this.Name);
            if (string.IsNullOrEmpty(this.ControlName)) 
            {
                this.ControlName = this.Name;
            }
            ...
            EIBControlCollection.Buttonlist.Add(this.Name, this.Name);
            counter = 0;
        }
    }
}
