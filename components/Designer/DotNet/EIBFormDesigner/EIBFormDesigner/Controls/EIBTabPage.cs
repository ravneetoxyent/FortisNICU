...
{  
    public class EIBTabPage : EIBTabPageBase
    {
    }
    public class EIBTabPageBase : TabPage, ITool, IEIBControl, IContainerControl, ICustomSizableControl
    {
  ...
  TypeConverter(typeof(EIBFormDesigner.Property.IsForm)), Description("Sets the Form Status"), Category("Data")]
        ...
        internal static int counter = 3;
        int width = 150;
        int height = 150;
        public EIBTabPageBase()
        {
