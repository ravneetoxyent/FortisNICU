...
#Region "Class Variables"
    ...
    Public Shared KEY_PUBLIC As String = "public.key"
    Public Shared KEY_PRIVATE As String = "private.key"
...
#Region "Shared Cryptographic Functions"
    ...
    Private Shared Function RSAEncrypt(ByVal plainText As Byte()) As Byte()
        ...
        'ValidateRSAKeys()
        Dim publicKey As String = KEY_PUBLIC
        Dim privateKey As String = KEY_PRIVATE
        If String.IsNullOrEmpty(publicKey) Or String.IsNullOrEmpty(privateKey) Then
            Throw New CryptographicException(ERR_INVALID_PROVIDER)
        End If
