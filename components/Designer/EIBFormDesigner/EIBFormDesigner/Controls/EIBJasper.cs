...
{
    public class EIBJasper : EIBJasperBase
    {

    }
    public class EIBJasperBase : Panel, ITool, IEIBControl, ICustomSizableControl
    {
  ...
  TypeConverter(typeof(EIBFormDesigner.Property.IsForm)), Description("Sets the Form Status"), Category("Data")]
        ...
        public EIBJasperBase()
        {
            if (string.IsNullOrEmpty(this.Name))
            {
                this.Name = "jasperreport" + counter;
            }
            ...
            this.AccessibleName = "jasperreport" + counter;
