...
{
    class EIBCheckbox : EIBCheckboxBase
    {
    }
    class EIBCheckboxBase : CheckBox, ITool, IEIBControl, ICustomSizableControl
    {
  ...
  TypeConverter(typeof(EIBFormDesigner.Property.IsForm)), Description("Sets the Form Status"), Category("Data")]
        ...
        private bool visible = true;public bool getVisibility() { return visible;}[Browsable(true)] public new bool Visible { get { return base.Visible; } set { visible = value; base.Visible = value; } }

        public EIBCheckboxBase()
        {
            this.Size = new Size(width, height);
            if (string.IsNullOrEmpty(this.Name))
            {
                this.Name = "checkbox" + counter;
            }
            ...
            //this.Font =new Font(FontFamily.Families[1],9f);
        }
        public void InitiateSettings(EIBFormDesigner.Designer.FormDesigner form)
        {

            this.Name = EIBControlCollection.CheckControlForUniqueness<EIBCheckbox>(this.Name);
            if (string.IsNullOrEmpty(this.ControlName))
            {
                this.ControlName = this.Name;
            }
            EIBControlCollection.CheckBoxlist.Add(this.Name, this.Name);
            counter = 0;
        }
