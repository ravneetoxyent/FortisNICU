...
{
    public class EIBRadioButton : EIBRadioButtonBase
    {
    }
    public class EIBRadioButtonBase : RadioButton, ITool, IEIBControl, ICustomSizableControl
    {
  ...
  TypeConverter(typeof(EIBFormDesigner.Property.IsForm)), Description("Sets the Form Status"), Category("Data")]
        ...
        public EIBRadioButtonBase()
        {
            this.Size = new Size(width, height);
            if (string.IsNullOrEmpty(this.Name))
            {
                this.Name = "RadioButton" + counter;
            }
            ...
            this._Width = width;
            this.Text = "RadioButton" + counter.ToString();
