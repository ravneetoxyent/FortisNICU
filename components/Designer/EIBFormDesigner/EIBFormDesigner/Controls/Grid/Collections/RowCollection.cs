...
namespace EIBFormDesigner.Controls.Grid.Collections
{
	...
	public class RowCollection : IList
	{
		...
		public EIBRow this[int index]
		{
			get
			{
                return parentTable.Controls[index] as EIBRow;
			}
		}
		...
		{
            this.parentTable.Controls.Remove(value as EIBRow);
		}
		...
		public void Clear()
		{
            foreach (EIBRow ctrl in this.parentTable.Controls)
				if (ctrl != null)
		...
		{
            this.parentTable.Controls.Add(value as EIBRow);
            return this.parentTable.Controls.IndexOf(value as EIBRow);
		}

        public void Add(EIBRow value)
		{
