...
{
    public class EIBPicture : EIBPictureBase
    {
    }
    public class EIBPictureBase : PictureBox, ITool, IEIBControl, ICustomSizableControl
    {
  ...
  TypeConverter(typeof(EIBFormDesigner.Property.IsForm)), Description("Sets the Form Status"), Category("Data")]
        ...
        public EIBPictureBase()
        {
            this.BackColor = Color.White;
            this.Size = new Size(width, height);
            if (string.IsNullOrEmpty(this.Name))
            {
                this.Name = "picture" + counter;
            }
            ...
            this.Text = "picture" + counter.ToString();
