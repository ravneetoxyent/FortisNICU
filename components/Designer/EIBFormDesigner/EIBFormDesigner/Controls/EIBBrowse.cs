...
{
    class EIBBrowse : EIBBrowseBase
    {

    }
    class EIBBrowseBase : Button, ITool, IEIBControl, ICustomSizableControl
    {
  ...
  TypeConverter(typeof(EIBFormDesigner.Property.IsForm)), Description("Sets the Form Status"), Category("Data")]
        ...
        public EIBBrowseBase()
        {
            if (string.IsNullOrEmpty(this.Name))
            {
                this.Name = "browse" + counter;
            }
        ...
        {
            this.Name = EIBControlCollection.CheckControlForUniqueness<EIBBrowse>(this.Name);
            if (string.IsNullOrEmpty(this.ControlName))
            {
                this.ControlName = this.Name;
            }
            EIBControlCollection.Browselist.Add(this.Name, this.Name);
            counter = 0;
        }
