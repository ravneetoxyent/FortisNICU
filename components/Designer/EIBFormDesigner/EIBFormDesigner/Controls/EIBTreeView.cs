...
{
    class EIBTreeView : EIBTreeViewBase
    {
    }
    class EIBTreeViewBase : TreeView, ITool, IEIBControl, ICustomSizableControl
    {
  ...
  TypeConverter(typeof(EIBFormDesigner.Property.IsForm)), Description("Sets the Form Status"), Category("Data")]
        ...
        public EIBTreeViewBase()
        {
            this.Size = new Size(width, height);
            if (string.IsNullOrEmpty(this.Name))
            {
                this.Name = "treeView" + counter;
            }
            ...
            this._Width = width;
            this.Text = "treeView" + counter.ToString();
