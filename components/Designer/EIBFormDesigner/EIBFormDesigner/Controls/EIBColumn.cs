...
[Browsable(false)] public new Padding Margin { get { return base.Margin; } set { base.Margin = value; } } 
        string use;
  ...
  TypeConverter(typeof(EIBFormDesigner.Property.IsForm)), Description("Sets the Form Status"), Category("Data")]
			...
			{ 
                ...
                if (this.Parent != null)
                {
                    if (this.Parent.Parent is EIBLattice)
                    {
                        ...
                        foreach (EIBRow row in rowscollection)
                        {
		...
		public ColumnCollection Columns
		{
			...
			{
				if (this.Parent is EIBRow)
                    return (this.Parent as EIBRow).Columns;
